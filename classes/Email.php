...
class Email{
  ...
  public function enviarInstrucciones(){
    ...
    $mail->setFrom('cuentas@appsalon.com');
    $mail->addAddress('cuentas@appsalon.com', 'Appsalon.com');
    $mail->Subject = 'Reestablecer el Password';
    //Set HTML
    $mail->isHTML(true);
    $mail->CharSet = 'UTF-8';
    $mail->Body = "
      ...
      <body>
          <h1>BarberShop</h1>
          <h2>¡Estas Solicitando Reestablecer Tu Password!</h2>
          <p><strong>Hola " . $this->nombre . "</strong> Has solicitado reestablecer tu password en AppSalon, Por Favor, sigue el siguiente enlace para hacerlo</p>
          <a href='" . $_ENV['APP_URL'] . "/recuperar?token=" . $this->token . "'><button>Reestablecer Password</button></a>
          <p>Si tú no solicitaste Reestablecer tu Password en BarberShop, por favor ignora este correo electrónico.</p>
          <div><p></p></div>
          <p><span>Este correo electrónico fue enviado desde una dirección solamente de notificaciones que no puede aceptar correo electrónico entrante. Por favor no respondas a este mensaje.</span></p>
      </body>
      </html>";
